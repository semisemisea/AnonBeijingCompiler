...
impl fmt::Display for Inst {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            Inst::add { rd, op1, op2 } => write!(f, "add {rd:?}, {op1:?}, {op2}"),
            Inst::sub { rd, op1, op2 } => write!(f, "sub {rd:?}, {op1:?}, {op2}"),
            Inst::mul { rd, op1, op2 } => write!(f, "mul {rd:?}, {op1:?}, {op2:?}"),
            Inst::sdiv { rd, op1, op2 } => write!(f, "sdiv {rd:?}, {op1:?}, {op2:?}"),
            Inst::udiv { rd, op1, op2 } => write!(f, "udiv {rd:?}, {op1:?}, {op2:?}"),
            Inst::neg { rd, src } => write!(f, "neg {rd:?}, {src:?}"),
            Inst::cmp { op1, op2 } => write!(f, "cmp {op1:?}, {op2}"),
            Inst::and { rd, op1, op2 } => write!(f, "and {rd:?}, {op1:?}, {op2}"),
            Inst::orr { rd, op1, op2 } => write!(f, "orr {rd:?}, {op1:?}, {op2}"),
            Inst::eor { rd, op1, op2 } => write!(f, "eor {rd:?}, {op1:?}, {op2}"),
            Inst::lsl { rd, op1, op2 } => write!(f, "lsl {rd:?}, {op1:?}, {op2}"),
            Inst::lsr { rd, op1, op2 } => write!(f, "lsr {rd:?}, {op1:?}, {op2}"),
            Inst::asr { rd, op1, op2 } => write!(f, "asr {rd:?}, {op1:?}, {op2}"),
