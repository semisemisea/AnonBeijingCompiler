 ...
 * and optimized.
 *
 * Local provenance: copied from regalloc2 0.15.1 `src/ion/spill.rs`.
 * Local modifications map regalloc2 interfaces to `taki_mir::reg_alloc`
 * and omit unavailable output statistics.
 */
